...
image_path = os.path.join("d:/Users/brucekv/Desktop/Krajta/Python", "derek.webp")
...
image_path = os.path.join("d:/Users/brucekv/Desktop/Krajta/Python", "george.jfif")
block = pygame.image.load(image_path).convert_alpha()




score, speed = 0, 10  # skóre hráče a rychlost pádu
